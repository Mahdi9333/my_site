        ...
        <main className="min-h-screen flex flex-col items-center justify-between bg-[#0F172A] text-[#F8FAFC]">
            ...
            <section className="mt-12 text-center px-6">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3 leading-tight">
                    پلتفرمی که هم مسیر یادگیری برنامه‌نویسیه، هم راهنمای انتخاب لپ‌تاپ؛
                    <span className="block text-[#38BDF8] mt-2">نقطه‌ای برای ساختن مهارت و انتخاب بهتر</span>
                </h1>
                <p className="text-sm md:text-base text-[#94A3B8] max-w-2xl mx-auto mt-4">
                    آموزش مرحله‌ای و پروژه‌محور + بررسی‌های تخصصی لپ‌تاپ‌ها؛ هر چیزی که برای یاد گرفتن و انتخاب لازم داری اینجا جمع شده
                </p>
            </section>
            ...
            <section className="w-full flex-1 flex items-center justify-center px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl w-full">
                    ...
                    {/* کارت آموزش برنامه‌نویسی */}
                    <Link
                        href="/learn"
                        className="relative rounded-2xl overflow-hidden shadow-2xl transform transition hover:scale-[1.02]"
                    >
                        <div className="w-full h-80 relative">
                            <Image src="/images/code.jpg" alt="آموزش برنامه‌نویسی" fill style={{ objectFit: "cover" }} />
                        </div>
                        <div className="absolute bottom-0 left-0 right-0 bg-black/55 p-4">
                            <h2 className="text-xl md:text-2xl font-bold">آموزش برنامه‌نویسی</h2>
                            <p className="text-sm text-[#D1D5DB] mt-1">مسیر یادگیری از صفر تا حرفه‌ای — درس‌های پروژه‌محور و کاربردی</p>
                        </div>
                    </Link>

                    {/* کارت معرفی و مقایسه تخصصی لپ‌تاپ‌ها */}
                    <Link
                        href="/compare"
                        className="relative rounded-2xl overflow-hidden shadow-2xl transform transition hover:scale-[1.02]"
                    >
                        <div className="w-full h-80 relative">
                            <Image src="/images/laptop.jpg" alt="معرفی و مقایسه لپ‌تاپ‌ها" fill style={{ objectFit: "cover" }} />
                        </div>
                        <div className="absolute bottom-0 left-0 right-0 bg-black/55 p-4">
                            <h2 className="text-xl md:text-2xl font-bold">آشنایی و مقایسهٔ تخصصی لپ‌تاپ‌ها</h2>
                            <p className="text-sm text-[#D1D5DB] mt-1">بررسی مدل‌ها، مقایسهٔ فنی و راهنمای خرید برای نیازهای واقعی</p>
                        </div>
                    </Link>
